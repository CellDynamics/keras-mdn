...
def mdn_loss_2d(y_true, y_pred):
    ...
    # implementing eq # 26 of http://arxiv.org/abs/1308.0850 (Graves)
...
def tf_2d_normal(x1, x2, mu1, mu2, s1, s2, rho):
    # eq # 24 and 25 of http://arxiv.org/abs/1308.0850 (Graves)
...
def get_mixture_coef(output):
    ...
    # ie, eq 18 -> 23 of http://arxiv.org/abs/1308.0850 (Graves)
